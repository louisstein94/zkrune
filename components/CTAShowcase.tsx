  ...
  return (
    <section className="relative py-24 px-16 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="bg-gradient-to-br from-zk-dark/50 to-zk-darker/50 border border-zk-primary/20 rounded-3xl p-12 md:p-16 text-center backdrop-blur-sm">
          {/* Floating Runes */}
          ...
          <p className="mt-6 text-sm text-zk-gray">
