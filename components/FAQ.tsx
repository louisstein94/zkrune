...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes! We use real Groth16 zk-SNARKs - the same cryptography securing billions in blockchain transactions. All 5 templates use compiled Circom circuits. These aren't simulations or demos. They're mathematically verifiable zero-knowledge proofs that anyone can verify.",
      category: "technical"
    },
    {
