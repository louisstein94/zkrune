...
> **Runnable example:** [`examples/age-gate-widget`](https://github.com/louisstein94/zkrune/tree/main/examples/age-gate-widget) — single-file HTML page that gates content behind an age proof.
